...
const staticModels: ModelInfo[] = [
  ...
  { name: 'Qwen/Qwen2-VL-72B-Instruct', label: 'Qwen2-VL-72B', provider: 'Hyperbolic' },
  ...
  { name: 'gemini-exp-1121', label: 'Gemini 1121', provider: 'Google' },
  { name: 'gemini-exp-1206', label: 'Gemini 1206', provider: 'Google' },
